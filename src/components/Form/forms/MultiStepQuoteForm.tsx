    ...
    >
      <FormStep title="Personal Information">
        <div className="flex flex-col lg:flex-row gap-4 mb-4">
          <Input
            ...
            inputClassName="w-full px-4 py-3 bg-text/5 cbc-border rounded-md focus:outline-none focus:border-white/30"
          />
      ...
      <FormStep title="Company Information">
        ...
        <Select
          ...
          selectClassName="w-full px-4 py-3 bg-text/5 cbc-border rounded-md focus:outline-none focus:border-white/30"
        />
      ...
      <FormStep title="Project Details">
        ...
        <Textarea
          ...
          rows={6}
          containerClassName="mb-4"
          textareaClassName="w-full px-4 py-3 bg-text/5 cbc-border rounded-md focus:outline-none focus:border-white/30 resize-vertical"
        />
