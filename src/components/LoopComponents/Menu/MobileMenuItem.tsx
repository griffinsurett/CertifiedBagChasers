        ...
        >
          {hasUrl ? (
            <a
              ...
              className="flex-1 py-3 font-medium text-text-muted hover:text-primary transition-colors"
            >
              {title}
            </a>
          ) : (
            <button
              ...
              className="flex-1 py-3 text-left font-medium text-text-muted hover:text-primary transition-colors"
            >
              {title}
            </button>
          )}
  ...
  return (
    <li>
      <a
        ...
        target={openInNewTab ? "_blank" : undefined}
        rel={openInNewTab ? "noopener noreferrer" : undefined}
        className="block py-3 px-4 text-text-muted hover:text-primary rounded-md transition-colors"
        style={{ paddingLeft: `${indent + 16}px` }}
      >
        {title}
      </a>
