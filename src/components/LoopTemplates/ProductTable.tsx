        ...
        return (
          <div
            ...
            className={`
              ...
              ${isMostPopular
                ? "bg-gradient-to-br from-[#08140d] via-[#050d08] to-[#040906] cbc-border-2 scale-100 lg:scale-105 z-10 shadow-[0_25px_50px_rgba(255,255,255,0.08)]"
            ...
            `}
          >
            {/* Subtle halo for featured card */}
            {isMostPopular && (
              <div className="absolute inset-[-2px] rounded-[22px] bg-gradient-to-br from-white/20 via-white/10 to-transparent opacity-18 -z-10" />
            )}
